...
sbatch --array=0-36 --job-name=wsclean_ms --output=logs/wsclean_%A_%a.out --error=logs/wsclean_%A_%a.err --export=ALL,SBID=SB77974,DATA_ROOT=/fred/oz451/${USER}/data,PATTERN="*beam{beam:02d}*.avg.calB0.ms",IMG_TAG="initial",FLINT_WSCLEAN_SIF=/fred/oz451/${USER}/containers/flint-containers_wsclean.sif,BIND_SRC=/fred/oz451 run_wsclean_beams.sh
