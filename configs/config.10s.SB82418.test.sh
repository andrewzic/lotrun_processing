...
DATA_ROOT="${DATA_ROOT:-/fred/oz451/${USER}/data/continuum/test}"
OUT_ROOT="${OUT_ROOT:-/fred/oz451/${USER}/data/continuum/test}"
...
FLAG_OUTER=${FLAG_OUTER:-"1"} # Whether to flag outer antennas to match the inner antennas used by CRACO
